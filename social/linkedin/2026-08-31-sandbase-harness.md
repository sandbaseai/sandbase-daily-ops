...
The Hugging Face [agent-harness registry PR #2432](https://github.com/huggingface/huggingface.js/pull/2432) is now merged at [`56e5168`](https://github.com/huggingface/huggingface.js/commit/56e5168c42132c3b90aacbb1dfdc18f41debde6d). The final integration removes `MANAGED_AGENTS_HOME` as an identity signal and pairs the registry entry with SandBase's default `AI_AGENT=sandbase-harness` child-process marker. Explicit nested-agent markers remain supported.
...
Three public discovery milestones are now confirmed. [Awesome Agent Plugins](https://github.com/ZeroPointRepo/awesome-agent-plugins#the-catalog-verified-agent-plugins) lists SandBase Harness under Dev & Coding. [Awesome DeepSeek Harness Top 500 issue #3](https://github.com/weekend-project-space/awesome-deepseek-harness-top-500/issues/3) was confirmed merged, and [Blue-Whale-Harness issue #153](https://github.com/leenkcool/Blue-Whale-Harness/issues/153) confirms the project in its generated catalog/site as a sandbox Runtime/MCP integration.

These are independent community listings, not endorsements, rankings, or security certifications. SandBase Harness remains self-hosted, and effective isolation depends on the selected execution backend and deployment configuration. The [official project Discussion](https://github.com/sandbaseai/sandbase-harness/discussions/116#discussioncomment-18216740) records the verification trail.
